...
- T-57-01 through T-57-08 are eight machine-green HIGH mitigations. The 220-case live-fixture matrix recursively scans every production Swift file plus package/resource/Demo owners, rejects canonical, synonym, neutral-file, alias, inert-route, active-Demo, ledger-promotion, scanner, and candidate-to-proxy mutations, while clean proxy-only shipped domains remain required controls.
