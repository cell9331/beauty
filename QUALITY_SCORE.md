...
- EVID-01 through EVID-05 and LID-01 now have automated mutation coverage for manifest/path/budget validation, genuine-evidence selection, immutable review, independent reducers, upper-eyelid conjunction, safe local UI, positive-allowlist export, owner synchronization, Git isolation, and production-scope absence. The frozen UI inventory remains exactly `27 = 8 considerations + 19 acceptance criteria`, and all six ASVS Level 1 HIGH mitigations remain executable.
