...
- Final focused SwiftPM passes 141/141. The post-review checker passes 490 aggregate live-fixture mutation/scanner/inventory/owner cases, per-threat totals `65 / 38 / 35 / 199 / 23 / 81 / 7 / 42`, all eight independent modes, and clean decision/live classification. It now covers unsuffixed aliases, recursive Demo IDs/titles, both owned proxy identities across six relation forms, exact evidence schemas/privacy shapes, fixed-output subprocess failures, and owner deletion/duplication/contradiction. Full SwiftPM executes 544 tests with six documented opt-in Vision skips and zero failures; explicit iPhone 17e/iOS 26.5 Demo build passes and Demo tests pass 120/120.
