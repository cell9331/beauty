...
- Current fixture cutover (2026-07-30): future live tests discover only the local, Git-ignored, rights-approved `p1.jpg` portrait plus `no-face-gradient.png`. The 2316×3088 active JPEG is 2,484,953 bytes, remains below the 16 MiB acquisition ceiling, and carries no GPS, capture-time, device, author, copyright, or orientation metadata. `e1`–`e6` and their prior generated outputs are parked outside active paths. Historical phase counts above remain evidence for their original fixtures and are not silently transferred to `p1`.
