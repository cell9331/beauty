...
- The final gate passes 141 focused SwiftPM tests, the 220-case checker with per-threat totals `65 / 32 / 27 / 19 / 19 / 33 / 7 / 18`, 544 full SwiftPM tests with six opt-in Vision skips, and 120/120 explicit Simulator tests. These results establish closed-route, privacy, compatibility, and recovery reliability only, not sclera or eyelid algorithms, outputs, device/performance, naturalness, commercial, shipping, or release guarantees.
