...
- [Phase 54] Teeth, sclera, and upper-eyelid gates are independently closed from the explicit empty eligible/review inventory; no sibling borrowing or implicit approval is allowed.
- [Phase 54] Mechanics-only media may prove local reviewer behavior but always contributes zero product-effectiveness and naturalness weight.
