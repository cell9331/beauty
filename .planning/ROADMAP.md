...
- [x] 05-01: Add resource manifest model and built-in preset resources.

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 05-02: Add color/filter parameter mapping and render/resource placeholders.
...
- [x] 06-02: Implement face-shape warp controls with naturalness caps.
...
- [x] 06-04: Implement mouth and lip MVP controls with safe missing-landmark behavior.

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 06-05: Add combined-effect safety, no-face degradation, and visual/regression tests.
