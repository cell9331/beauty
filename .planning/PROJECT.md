...
**Code size:** the immutable `v1.15` tag contains 49,018 tracked Swift source/test lines. The active post-archive SDK-only tree contains 66 Swift source files / 14,950 source lines and 60 SwiftPM test files / 29,738 test lines, excluding `.build` and archive contents.
...
safety, and determinism oracles. The generated preflight executes 9 + 9 + 15
tests with zero skips, and the final no-skip child executes 691 tests with all
