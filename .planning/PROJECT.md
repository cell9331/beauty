...
**Code size:** the immutable `v1.15` tag contains 49,018 tracked Swift source/test lines; the current post-archive tree contains 50,500 across `BeautySDK` and `BeautyDemo`, excluding `.build`.
