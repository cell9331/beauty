...
| --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| 52-01-01 | 01 | 1 | SAFE-01 | T-52-01–03 | One final cap authority; exact dead zone, direction, count, warning, and metric semantics | unit | Safety-cap + resolver focused suites | ✅ extend | ⬜ pending |
| 52-01-02 | 01 | 1 | SAFE-01, SAFE-02 | T-52-04–07 | Seven-field finite/unit/radius and fresh/reused/stale/missing/malformed/provider-empty matrix | unit | Provider + degradation focused suites | ✅ extend | ⬜ pending |
| 52-01-03 | 01 | 1 | SAFE-02 | T-52-06–08 | Stateless transitions, safe siblings, unchanged extent, aggregate-only facade diagnostics | integration | Facade focused suite | ✅ extend | ⬜ pending |
| 52-02-01 | 02 | 2 | SAFE-01, SAFE-02 | T-52-09–11 | Exact 44-field inventory, 13.45/44/1÷13.45 arithmetic, preserved signs | unit | Conflict + combined focused suites | ✅ extend | ⬜ pending |
...
| 52-03-01 | 03 | 3 | SAFE-03, DOC-01 | T-52-13–18 | Fail-closed pre/post-promotion, owner, privacy, dependency, artifact, and lifecycle checker | static + adversarial | Checker compile + self-test + default live | ❌ Wave 0 | ⬜ pending |
| 52-03-02 | 03 | 3 | SAFE-01, SAFE-02, SAFE-03 | T-52-19–22 | Fresh runtime plus unchanged strict output/gallery and disposable artifact evidence | full + integration | Focused/full SwiftPM + guarded strict/gallery commands | ✅ reuse | ⬜ pending |
| 52-03-03 | 03 | 3 | SAFE-03 | T-52-17, T-52-23 | Clean standard review, Nyquist coverage, ASVS L1 zero-open precondition | review + security | Review/security/validation artifact gates | ❌ Wave 3 | ⬜ pending |
| 52-04-01 | 04 | 4 | DOC-01 | T-52-24–25 | Fresh evidence reauthorizes only the exact eyebrow status transaction | static | Default checker + evidence/precondition gates | ❌ Wave 0 | ⬜ pending |
| 52-04-02 | 04 | 4 | DOC-01 | T-52-24–27 | Exactly seven rows and branch `眉毛` become implemented; all future/nonclaims preserved | docs/static | Post-promotion checker mode | ❌ Wave 0 | ⬜ pending |
| 52-05-01 | 05 | 5 | SAFE-03, DOC-01 | T-52-21, T-52-26 | Example owners retain exact output vocabulary, disposable artifacts, final cap/safety result | docs/static | Example-owner checker mode + helper/gallery self-tests | ❌ Wave 0 | ⬜ pending |
| 52-05-02 | 05 | 5 | SAFE-01, SAFE-02, SAFE-03, DOC-01 | T-52-26–28 | Routed root owners agree on caps, lifecycle, privacy, reliability, product, and quality | docs/static | Per-owner and aggregate owner checker modes | ❌ Wave 0 | ⬜ pending |
| 52-06-01 | 06 | 6 | SAFE-01, SAFE-02, SAFE-03, DOC-01 | T-52-27–29 | Close exact requirements/plans only after executable evidence; audit remains pending | docs/static | Requirement/roadmap/state/plans checker modes | ❌ Wave 0 | ⬜ pending |
| 52-06-02 | 06 | 6 | SAFE-01, SAFE-02, SAFE-03, DOC-01 | T-52-23–29 | Goal-backward verification and complete final gate hand off honestly to milestone audit | verify | Full final command bundle + final checker | ❌ Wave 6 | ⬜ pending |
...
- [ ] Exact seven-row cap/dead-zone/radius oracle in existing safety/resolver/provider tests.
- [ ] One typed seven-field lifecycle/local-failure descriptor in existing degradation tests.
