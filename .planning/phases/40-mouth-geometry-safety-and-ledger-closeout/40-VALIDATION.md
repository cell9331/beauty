...
| --- | --- | --- | --- |
| 40-01 | MOUTH-12 | cap/resolver/provider/degradation/facade focused suites | pending |
| 40-01 | MOUTH-13 | eight-field support/freshness/provider/transition tables | pending |
| 40-02 | MOUTH-14 | exact combined/conflict/degradation/provider suites | pending |
| 40-03 | MOUTH-15 | self-tested active-source checker, full SwiftPM, renderer/helper/artifact gates | pending |
| 40-04 | MOUTH-16 | exact promotion assertions and allow-promotion boundary run | pending |
| 40-04 | DOC-01 | owner-consistency checker, full tests, verification/security/review artifacts | pending |
