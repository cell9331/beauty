...
| 46-PROV-01 | smooth contour emission | GEOM-01 | T-46-02, T-46-05 | finite bounded neighbor-chord movement reduces local roughness without proxy fallback or whole-face scale change | provider unit | `swift test --package-path BeautySDK --disable-sandbox --filter BeautyEffectsTests.FaceShapeWarpProviderTests` | ✅ extend | ⬜ pending |
