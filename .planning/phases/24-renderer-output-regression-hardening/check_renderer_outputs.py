...
def expected_output_names() -> list[str]:
    return [
        f"{Path(fixture_name).stem}__{case_id}.png"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate generated renderer PNG outputs.")
...
def main() -> int:
    ...
    for fixture_name in FIXTURE_NAMES:
        ...
        try:
            ...
            failures.append(f"{fixture_label}: unreadable")
            continue
