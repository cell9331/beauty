...
| 26-02-02 | 02 | 1 | GEO-02 | T-26-02-02 | Public result evidence stays limited to `BeautyDetectionSummary`, warnings, and aggregate numeric metrics; no coordinates, bounds, landmarks, control points, paths, raw framework errors, image bytes, or raw JSON leak. | focused XCTest/static scan | `rg -n "VNFaceObservation|boundingBox|landmark|controlPoint|/private/var|NSError|AVError|rawPresetJson|raw JSON|image bytes" BeautySDK/Sources/BeautyCore BeautySDK/Sources/BeautySDK BeautySDK/Sources/BeautyDetection BeautySDK/Sources/BeautyEffects BeautyDemo/BeautyDemo || true` | existing scan surface | pending |
